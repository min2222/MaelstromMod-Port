...
import com.barribob.mm.event_handlers.FogHandler;
...
public class CliffCloudRenderer extends IRenderHandler implements ISelectiveResourceReloadListener {
    ...
    public void render(float partialTicks, ClientLevel world, Minecraft mc) {
        ...
        for (int i = 0; i < FogHandler.SWAMP_FOG_LAYERS; i++) {
            ...
            int maxAlpha = 80;
            double entityHeight = entity.getEyePosition(partialTicks).y;
    ...
    public void renderPlane(float partialTicks, ClientLevel world, Minecraft mc, float height, Vec3 colorTweak, int alpha) {
        ...
        double totalOffset = partialTicks + entity.tickCount;
