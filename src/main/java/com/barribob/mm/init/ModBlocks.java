...
import com.barribob.mm.blocks.BlockAzureFlower;
import com.barribob.mm.blocks.BlockAzureGrass;
import com.barribob.mm.blocks.BlockAzureLeaves;
import com.barribob.mm.blocks.BlockAzureOre;
import com.barribob.mm.blocks.BlockAzureRedstoneOre;
import com.barribob.mm.blocks.BlockAzureVines;
import com.barribob.mm.blocks.BlockAzureVinesBlock;
import com.barribob.mm.blocks.BlockBase;
import com.barribob.mm.blocks.BlockBossSpawner;
import com.barribob.mm.blocks.BlockChain;
import com.barribob.mm.blocks.BlockDecayingMaelstrom;
import com.barribob.mm.blocks.BlockDisappearingSpawner;
import com.barribob.mm.blocks.BlockDoubleBrownedGrass;
import com.barribob.mm.blocks.BlockFan;
import com.barribob.mm.blocks.BlockFenceBase;
import com.barribob.mm.blocks.BlockFullLog;
import com.barribob.mm.blocks.BlockGrate;
import com.barribob.mm.blocks.BlockLamp;
import com.barribob.mm.blocks.BlockLightingUpdater;
import com.barribob.mm.blocks.BlockLogBase;
import com.barribob.mm.blocks.BlockMaelstrom;
import com.barribob.mm.blocks.BlockMaelstromCore;
import com.barribob.mm.blocks.BlockMaelstromHeart;
import com.barribob.mm.blocks.BlockMegaStructure;
import com.barribob.mm.blocks.BlockModTallGrass;
import com.barribob.mm.blocks.BlockNexusTeleporter;
import com.barribob.mm.blocks.BlockPillarBase;
import com.barribob.mm.blocks.BlockPlumFilledLeaves;
import com.barribob.mm.blocks.BlockPlumLeaves;
import com.barribob.mm.blocks.BlockRedstoneBrick;
import com.barribob.mm.blocks.BlockSaplingBase;
import com.barribob.mm.blocks.BlockStairsBase;
import com.barribob.mm.blocks.BlockSwampLeaves;
import com.barribob.mm.blocks.key_blocks.BlockKey;
import com.barribob.mm.blocks.portal.BlockAzurePortal;
import com.barribob.mm.blocks.portal.BlockCliffPortal;
import com.barribob.mm.blocks.portal.BlockCrimsonPortal;
import com.barribob.mm.blocks.portal.BlockDarkNexusPortal;
import com.barribob.mm.blocks.portal.BlockNexusPortal;
...
import com.barribob.mm.items.ItemBlockvoid;
import com.barribob.mm.util.Reference;
import com.barribob.mm.world.gen.foliage.WorldGenAzureTree;
import com.barribob.mm.world.gen.foliage.WorldGenBigPlumTree;
import com.barribob.mm.world.gen.foliage.WorldGenPlumTree;
...
public class ModBlocks {
    ...
    public static final Block DISAPPEARING_SPAWNER = new BlockDisappearingSpawner("disappearing_spawner", Material.STONE);
    ...
    public static final Block CHAIN = new BlockChain("chain", Material.IRON, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.METAL, new AABB(0.425D, 0.0D, 0.425D, 0.575D, 1.0D, 0.575D)).setCreativeTab(ModCreativeTabs.BLOCKS);
    public static final Block MULTI_CHAIN = new BlockChain("multi_chain", Material.IRON, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.METAL, new AABB(0.25D, 0.0D, 0.25D, 0.75D, 1.0D, 0.75D)).setCreativeTab(ModCreativeTabs.BLOCKS);
    public static final Block LARGE_CHAIN = new BlockChain("large_chain", Material.IRON, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.METAL, new AABB(0.30D, 0.0D, 0.3D, 0.7D, 1.0D, 0.7D)).setCreativeTab(ModCreativeTabs.BLOCKS);
