...
public class RenderNonLivingEntity<T extends Entity> extends Render<T> {
    ...
    public RenderNonLivingEntity(RenderManager renderManagerIn, String texture, Model mainModel, float yRenderOffset) {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        this.mainModel.setRotationAngles(0, 0, entity.tickCount + partialTicks, 0, 0, 0.0625F, entity);
        this.bindEntityTexture(entity);
        if (flag) {
            this.unsetBrightness();
        }

        this.renderModel(entity, 0, 0, entity.tickCount + partialTicks, 0, 0, 0.0625F);
