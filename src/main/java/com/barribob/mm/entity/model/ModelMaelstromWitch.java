...
public class ModelMaelstromWitch extends ModelAnimated {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.nose.rotateAngleX = Mth.sin((float) entityIn.tickCount * f) * 4.5F * 0.017453292F;
        this.nose.rotateAngleY = 0.0F;
        this.nose.rotateAngleZ = Mth.cos((float) entityIn.tickCount * f) * 2.5F * 0.017453292F;
