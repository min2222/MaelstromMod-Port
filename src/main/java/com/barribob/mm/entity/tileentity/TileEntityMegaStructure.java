...
public class TileEntityMegaStructure extends TileEntityStructure {
    ...
    public boolean save(boolean writeToDisk) {
        if (this.mode == TileEntityStructure.Mode.SAVE && !this.level.isClientSide && !StringUtils.isNullOrEmpty(this.name)) {
...
//            return true;
    ...
    public boolean load(boolean requireMatchingSize) {
        if (this.mode == TileEntityStructure.Mode.LOAD && !this.level.isClientSide && !StringUtils.isNullOrEmpty(this.name)) {
            BlockPos blockpos = this.getPos();
    ...
    public boolean isStructureLoadable() {
        if (this.mode == TileEntityStructure.Mode.LOAD && !this.level.isClientSide) {
            ServerLevel worldserver = (ServerLevel) this.world;
            MinecraftServer minecraftserver = this.world.getMinecraftServer();
            TemplateManager templatemanager = worldserver.getStructureTemplateManager();
