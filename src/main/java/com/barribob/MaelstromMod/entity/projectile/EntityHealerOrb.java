...
public class EntityHealerOrb extends Entity {
        ...
        if (!this.world.isRemote && this.world.getDifficulty() == EnumDifficulty.PEACEFUL) {
            ...
            if (!this.world.isRemote) {
                ...
                if (this.target == null || !this.target.isEntityAlive() || this.target instanceof Player && ((Player) this.target).isSpectator()) {
                    ...
                    Vec3 direction = this.tempTarget.subtract(getPositionVector()).normalize();
            ...
            if (this.world.isRemote) {
                 ...
                 */
                Vec3 direction = this.tempTarget.subtract(getPositionVector()).normalize();
                Vec3 lookahead = this.getPositionVector().add(direction.scale(2));
    ...
    public void findNextTargetPosition() {
        Vec3 targetPos = this.target.getPositionVector().add(new Vec3(target.motionX, target.motionY, target.motionZ).scale(3));
        Vec3 diff = targetPos.subtract(this.getPositionVector());
